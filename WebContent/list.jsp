		...
		<div class="row">
			<div class="col-md-offset-2 col-md-8">
				<div id="outer">
					...
					<form name="listmath" onclick="window.location.href='listmath'"
						action="listmath" method="get">
						<button class="button1" type="button">All Problems</button>
					</form>
				</div>
				<table width="100%" class="table table-bordered table-striped">
					...
					<tr>
						...
						<td>
							<form action="keywordHandlerServlet" method="get">
								<input type="hidden" name="keywordPid" value="<%=prob.getPid()%>">
								Add problem keyword: <br>
								<input type="text" name="problemKeyword" required><br>
								<button type="submit">Submit</button> <br>
							</form>
						</td>
<%-- 						<td width="84%"><%=prob.getKeywordList()%></td>
 --%>					</tr>
					<%
						}
					%>
				...
				<div>
					<form action="keywordHandlerServlet" method="post">
